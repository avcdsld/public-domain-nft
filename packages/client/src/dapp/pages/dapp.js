    ...
    let content = html`
      <div class="container m-auto">
        <div class="row fadeIn mt-3 p-2 block">
          ...
          <p class="mt-3">
            GitHub: <a target="_blank" href="https://github.com/avcdsld/public-domain-nft">https://github.com/avcdsld/public-domain-nft</a>
          </p>
          <p class="mt-3">
            Powered by <a target="_blank" href="https://www.decentology.com/">Decentology</a>, <a target="_blank" href="https://onflow.org/">Flow Blockchain</a>, and <a target="_blank" href="https://metmuseum.github.io/">The Metropolitan Museum of Art Collection API</a>
          </p>
        </div>
      </div>
    `;
